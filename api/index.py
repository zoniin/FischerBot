...
def new_game():
    ...
    try:
        ...
        depth_map = {
            'easy': 4,      # Searches up to depth 4 (usually gets 3-4)
            'medium': 6,    # Searches up to depth 6 (usually gets 5-6) ~2000 Elo
            'hard': 10      # Searches up to depth 10 (usually gets 6-8) ~2400-2700 Elo
        }
